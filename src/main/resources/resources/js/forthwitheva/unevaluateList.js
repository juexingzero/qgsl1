...
function detailRow(gridId,row_uid){
	...
	//window.location.href = "/web/v1/institution/toUnevaluatePage?forthwith_id=" + row.forthwith_id;
	 mini.open({
        url: "/web/v1/forthwitheva/toUnevaluatePage?forthwith_id=" + row.forthwith_id,
        title: "即时评价-未回复",
        width: 800,
        height: 700,
        allowResize:false,
