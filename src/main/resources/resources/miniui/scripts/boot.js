...
//图标颜色样式
//document.write('<link href="/static/organizational/css/iconColor.css" rel="stylesheet" type="text/css" />');
...
window.onload = function(){
 ...
 $("#btnSenior").click(function(){
     $("#normalTable").hide();
     $("#seniorTable").show();
     $("#fast_mode").text("高级");
     var searchForm = new mini.Form("#normalTable");
     searchForm.clear();
     mini.get("keyWord").select(0);
     mini.get("mini-fit").doLayout();
 });
