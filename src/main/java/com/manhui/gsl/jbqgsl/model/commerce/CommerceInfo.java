...
/**
 * @类名称 CommerceInfo.java
 * @类描述 商会信息
 * @作者 kevin kwmo1005@163.com
 * @创建时间 2018年10月25日 上午10:26:07
 * @版本 1.00
 *
 * @修改记录
 * 
...
public class CommerceInfo {
    ...
    private String  commerce_order;         //商会序号
    private String  commerce_linkman_name;  //商会联系人姓名
    private String  commerce_linkman_phone; //商会联系人电话
    private String  commerce_describe;      //商会介绍
