...
public class OrganizationalServiceImpl implements IOrganizationalService {
    ...
    public List<Position> queryPositionToDept( Position position ) {
    	if("".equals(position.getSortField()) ||"".equals(position.getSortOrder())) {
    		position.setSortField("dept_name");
    		position.setSortOrder("desc");
    	}
	...
	@Override
	public int checkSysUser(User user) {
		return organizationalMapper.checkSysUser(user);
	}

	@Override
	public int updatePwd(User user) {
		return organizationalMapper.updatePwd(user);
	}

    @Override
	public String getInnerOuterDeptFlagByUserId(String user_id) {
        return organizationalMapper.getInnerOuterDeptFlagByUserId(user_id);
    }
}
